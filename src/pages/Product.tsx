      ...
      <section id="product">
        <div className="hero">
          <div className="text">
            ...
            <div className="content">
              {' '}
              Merch can boost morale, create hype, raise revenue, maintain brand
              loyalty and just makes people feel good.
            </div>
          </div>
        </div>
        <div className="container-fluid">
          <div className="row">
            <div className="col-2">
              <ProductNavBar
                merchendiseProductList={merchendiseProductList}
                uniformProductList={uniformProductList}
              />
            </div>
