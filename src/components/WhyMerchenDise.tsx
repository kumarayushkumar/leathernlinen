      ...
      <div className="center">
        <div className="text">
          <div className="heading">
            Why merchandise <br /> and gifts
          </div>
          <div className="content">
            <p>
              Increase brand awareness Create brand advocates Generate leads
              Increase sales
            </p>

            <p>
              Here are some additional tips for using merch effectively as a
              marketing tool:
            </p>

            <p>
              Choose merch that is relevant to your target audience Make sure
              the merch is high-quality. Promote your merch Give away free merch
            </p>
          </div>
        </div>
